...
Value setgenerate(const Array& params, bool fHelp)
{
    ...
    Generateapplebycoins(fGenerate, pwalletMain);
    return Value::null;
}
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "applebycoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "applebycoin is downloading blocks...");
